...
$artifacts = @(
    ...
    @{ Source = Join-Path $root "SHD-CORE\build\libs\shd-core-0.1.0.jar"; Name = "shd-core-0.1.0.jar" },
    @{ Source = Join-Path $root "SHD-UI-CLIENT\build\libs\shd-ui-client-0.1.0.jar"; Name = "shd-ui-client-0.1.0.jar" }
)
