...
public record ModReportPayload(int protocolVersion, List<ModEntry> mods) implements CustomPayload {
    public static final Identifier CHANNEL_ID = Identifier.of("shd-lifesteal-client", "mod_report");
    public static final Id<ModReportPayload> ID = new Id<>(CHANNEL_ID);
    ...
    public static final PacketCodec<RegistryByteBuf, ModReportPayload> CODEC = PacketCodec.of((payload, buffer) -> {
        ...
        return new ModReportPayload(protocolVersion, List.copyOf(entries));
    });
